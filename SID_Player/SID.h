...
#define SAMPLEFREQ 32000L

#define SAMPLERATECOUNT (F_CPU/(8*SAMPLEFREQ))
...
class SID
{
  ...
  public:
	...
	void setADSR(uint8_t voiceNumber,uint16_t attack_ms, uint16_t decay_ms, uint8_t sustain_level, uint16_t release_ms);
